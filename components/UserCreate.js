...
const UserCreate = () => {
    ...
    const handlesubmit= (e) => {
        e.preventDefault();
        const userdata = {name, email, phone, amountSaved, amountBorrowed}
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input value={name} onMouseDown={e=>valchange(true)} onChange={e=>namechange(e.target.value)} className="form-control" required></input>
